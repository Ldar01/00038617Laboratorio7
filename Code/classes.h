...
enum parameters {CONST_TAU, CONST_KAPPA, CONST_LAMBDA, CONST_DELTHA, CONST_ETA ,CONST_PSI_X,CONST_PSI_Y};
...
class mesh{
    ...
    public:
        void setParameters(float tau,float kappa,float lambda, float delta, float eta, float psi_x, float psi_y){
            parameters[CONST_TAU]= tau;
            parameters[CONST_KAPPA]= kappa;
            parameters[CONST_LAMBDA]=lambda;
            parameters[CONST_DELTHA]=delta;
            parameters[CONST_ETA]=eta;
            parameters[CONST_PSI_X]=psi_x;
            parameters[CONST_PSI_Y]=psi_y;
        }
